...
- **Лидерство**: систематизирую знания (база знаний, основа — [infostream](https://github.com/VitalyOstanin/infostream)); налаживаю работающие процессы разработки, тестирования и деплоя; на найме отличаю реально работающих от хорошо рассказывающих
